...
//		DWORD dwTic = GetTickCount();
		...
		nQueueCnt1 = CImageProcessCtrl::GetThreadQueuePtr(CAM_POS_TOP)->getTotalQueueCount();
		nQueueCnt2 = CImageProcessCtrl::GetThreadQueuePtr(CAM_POS_BOTTOM)->getTotalQueueCount();
