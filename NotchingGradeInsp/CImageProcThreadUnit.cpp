...
UINT CImageProcThreadUnit::CtrlImageProcThread_Exception(LPVOID pParam)
{
	...
	AprData.SaveDebugLog_Format(_T(">>>CImageProcThreadUnit Thread 갯수가 많을 때 처리 "));
	...
	while (true)
	{
		...
		//Judge 값을 가져온다.
		nJudge = pFrameRsltInfo->m_pTabRsltInfo->m_nJudge;
