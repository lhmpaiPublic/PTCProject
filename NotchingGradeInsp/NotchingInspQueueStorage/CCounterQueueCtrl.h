...
#include <queue>
#define MAX_COUNTER_QUEUE_SIZE 10//4 // 22.01.11 Ahn Modify 2->3
class CCounterInfo {
public :
	CCounterInfo() { nTabNo = 0; nTabID = 0;  nJudgement = 0; nMarkSel = 0; nMarkType = 0; nTabIdTotalCount = 0; nEnCoderCount = 0; };
	int nTabNo; // 검사기의 TabNo
	int nTabID;	// Counter의 TabId
	int nTabIdTotalCount; //TabId Total Count
	int nJudgement;
	int nMarkSel;
	int nMarkType;
	int nEnCoderCount;
